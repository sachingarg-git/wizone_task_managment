...
-- Run this script to create the ISP management tables
-- ============================================

-- ISP Clients table (Client Master) - ISP subscribers
...
-- Sample Network Devices (depends on network_towers existing)
...
SELECT 'ISP Management tables created successfully!' AS message;
