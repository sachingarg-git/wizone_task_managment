...
**TESTING CONFIRMED**: Admin login now works successfully on mobile APK with credentials:
- Username: `admin`
- Password: `admin123`

The mobile APK will now successfully login and access all features once generated and installed.
