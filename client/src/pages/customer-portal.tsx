...
import { Eye, EyeOff, MessageSquare, Clock, CheckCircle, AlertCircle, User, LogOut } from "lucide-react";
        ...
        <Card className="mb-8">
          ...
          <CardContent className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div>
              ...
              <p className="font-medium">{customerUser?.contactPerson}</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="font-medium">{customerUser?.mobilePhone}</p>
            </div>
            <div>
              <Label className="text-sm text-gray-500">Location</Label>
              <p className="font-medium">{customerUser?.city}, {customerUser?.state}</p>
            </div>
          </CardContent>
        </Card>
