...
console.log('🚀 Building Wizone APK with proper Gradle configuration...\n');
...
try {
    ...
    try {
        execSync('./gradlew clean', { cwd: androidProjectDir, stdio: 'inherit' });
    } catch (e) {
        console.log('⚠️  Clean command failed, continuing...');
    }
    
    // Build APK
    execSync('./gradlew assembleDebug', { cwd: androidProjectDir, stdio: 'inherit' });
